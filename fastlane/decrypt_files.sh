...
openssl aes-256-cbc -k $ENCRYPTION_PASSWORD -in $ABSOLUTE_PATH/Certificates/imbkDistribution.mobileprovision.enc -d -a -out $ABSOLUTE_PATH/Certificates/imbkDistribution.mobileprovision
